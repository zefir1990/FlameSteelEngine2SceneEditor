public class ConsoleViewRenderer: ViewRenderer {
    ...
    public func visit(_ button: Button) {
        ...
        let subRenderer = ConsoleViewRenderer(parent: button, depth: self.depth + 1, ioSystem: ioSystem)
    ...
    public func visit(_ panel: Panel) {
        ...
        for child in panel.children {
            let subRenderer = ConsoleViewRenderer(parent: panel, depth: self.depth + 1, ioSystem: ioSystem)
    ...
    public func visit(_ viewGroup: ViewGroup) {
        ...
        for view in viewGroup.views {
            let subRenderer = ConsoleViewRenderer(parent: viewGroup, depth: self.depth + 1, ioSystem: ioSystem)
    ...
    public func visit(_ modifiedView: ModifiedView) {
        ...
        let subRenderer = ConsoleViewRenderer(parent: modifiedView, depth: self.depth + 1, ioSystem: ioSystem)
    ...
    public func visit(_ objectsTreeView: ObjectsTreeView) {
        ...
        let subRenderer = ConsoleViewRenderer(parent: objectsTreeView, depth: self.depth + 1, ioSystem: ioSystem)
    ...
    public func visit(_ view: any View) {
        ...
        let subRenderer = ConsoleViewRenderer(parent: view, depth: self.depth + 1, ioSystem: ioSystem)
